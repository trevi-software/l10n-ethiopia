...
class res_partner(osv.Model):
    ...
    _columns = {
        ...
        'et_subcity': fields.char('Amharic Subcity (Woreda)', size=256, select=True),
...
class res_company(osv.Model):
    ...
    _columns = {
        ...
        'vat': fields.related('partner_id', 'vat', string="Tax ID", type="char", size=10),
        
        'vat_number': fields.char('VAT', size=10, select=True, help="Tax Identification Number"),
